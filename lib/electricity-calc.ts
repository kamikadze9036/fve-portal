...
export const ownUse = (row: Pick<ElectricityInterval, 'pvGenerationKwh' | 'inverterExportKwh' | 'pvSelfUseReportedKwh'>) => row.pvGenerationKwh != null && row.inverterExportKwh != null ? row.pvGenerationKwh - row.inverterExportKwh : row.pvSelfUseReportedKwh;
